...
const translations = {
  en: {
    ...
    // Expenses & Income Page
    expensesHeading: 'Shop Expenses & Extra Income',
    totalExpensesCard: 'Total Expenses',
    extraIncomeCard: 'Extra Income',
    netExpenseBalanceCard: 'Net Balance (Income - Expense)',
    ...
    expensesOnly: 'Expenses Only (खर्चे)',
    incomeOnly: 'Extra Income Only (अतिरिक्त आय)',
    recordExpenseBtn: '+ Record Expense',
    recordIncomeBtn: '+ Add Extra Income',
    typeCol: 'TYPE',
    dateCol: 'DATE',
    descCol: 'DESCRIPTION',
    catCol: 'CATEGORY',
  ...
  hi: {
    ...
    // Expenses & Income Page
    expensesHeading: 'दुकान के खर्चे व अतिरिक्त आय',
    totalExpensesCard: 'कुल खर्चे',
    extraIncomeCard: 'अतिरिक्त आय',
    netExpenseBalanceCard: 'नेट बैलेंस (आय - खर्च)',
    ...
    allTypes: 'सभी लेनदेन',
    expensesOnly: 'केवल खर्चे',
    incomeOnly: 'केवल अतिरिक्त आय',
    recordExpenseBtn: '+ नया खर्चा जोड़ें',
    recordIncomeBtn: '+ अतिरिक्त आय जोड़ें',
    typeCol: 'प्रकार',
    dateCol: 'तारीख',
    descCol: 'विवरण',
    catCol: 'श्रेणी',
