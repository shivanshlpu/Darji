...
import { InvoiceData } from '../utils/generateInvoice';
import '../styles/invoice.css';

export const InvoiceTemplate: React.FC<{ invoice?: InvoiceData | null }> = ({ invoice }) => {
          ...
          <div className="target-header-brand-box">
            ...
            <div className="target-brand-text-box">
              ...
              <div className="target-brand-address-box">
                ...
                <div>
                  80/LIG 1ST New Housing Board Colony<br />
                  Shahdol (M.P.) 484001
                </div>
              </div>
            </div>
